...
public class ReadApplicationPropertiesController {
     private Logger logger = LoggerFactory.getLogger(ReadApplicationPropertiesController.class) ;
    @Resource
    ...
    public String readProperties() throws IOException {
        ...
        logger.info("print configProperty fields:{}",properties);
        logger.info("print configProperty fields:{},{}",properties,"readProperties");
