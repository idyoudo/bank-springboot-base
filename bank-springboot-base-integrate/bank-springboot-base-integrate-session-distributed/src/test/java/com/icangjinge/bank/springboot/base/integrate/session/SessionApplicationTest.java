...
@SpringBootTest(classes = SessionDistributedApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
public class SessionApplicationTest {
    ...
    private ConfigurableApplicationContext createContext() {
        ConfigurableApplicationContext context = new SpringApplicationBuilder()
                .sources(SessionDistributedApplication.class)
